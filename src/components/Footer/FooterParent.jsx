              ...
              <div class="col-sm-6">
                ...
                <ul id="introduce-support" class="introduce-list">
                  <li>
                    <i class="fa fa-angle-double-right"></i
                    ><a
                      href="https://www.lazzpharma.com/Home/ContactUs"
                      style={{color: "white"}}
                      >Contact Us</a
                    >
                  </li>
                  <li>
                    <i class="fa fa-angle-double-right"></i
                    ><a
                      href="https://www.lazzpharma.com/Home/ReturnPolicy"
                      style={{color: "white"}}
                      >Return Policy</a
                    >
                  </li>
                  <li>
                    <i class="fa fa-angle-double-right"></i
                    ><a
                      href="https://www.lazzpharma.com/Home/TermsCondition"
                      style={{color: "white"}}
                      >Terms &amp; Conditions</a
                    >
                  </li>
                  <li>
                    <i class="fa fa-angle-double-right"></i
                    ><a
                      href="https://www.lazzpharma.com/Home/PrivacyPolicy"
                      style={{color: "white"}}
                      >Privacy Policy</a
                    >
                  </li>
              ...
              <ul id="trademark-list">
                <div class="introduce-title">
                  <b class="new-int-title"
                    >Pharmacy Software &amp; Website Developed By -</b
                  >
                </div>
                <div class="dev_com">
                  <a href="http://iqrasys.com/" target="_blank">
                    Iqrasys solutions Limited </a
